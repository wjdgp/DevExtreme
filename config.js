window.config = {
  ...
  map: {
    ...
    'devextreme-vue': 'npm:devextreme-vue@21.2.7',
    jszip: 'npm:jszip@3.7.1/dist/jszip.min.js',
    'devextreme-quill': 'npm:devextreme-quill@1.5.14/dist/dx-quill.min.js',
    'devexpress-diagram': 'npm:devexpress-diagram@2.1.47/dist/dx-diagram.js',
    'devexpress-gantt': 'npm:devexpress-gantt@4.0.13/dist/dx-gantt.js',
  ...
  packageConfigPaths: ['npm:@devextreme/*/package.json', 'npm:@devextreme/runtime@2.3.14/inferno/package.json'],
  babelOptions: {
    sourceMaps: false,
    stage0: true
  }
